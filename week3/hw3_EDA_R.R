...
---
  ...
  In this document, whose main purpose is to practice in data visualization, we will look at the happiness score and try to understand how much it really reflects the level of "happiness" in a country.
